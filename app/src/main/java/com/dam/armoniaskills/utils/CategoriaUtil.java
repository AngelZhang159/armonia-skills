...
public class CategoriaUtil {
    ...
    public static ArrayList<Categoria> rellenarLista(Context context) {
        ...
        String[] nombres = {context.getString(com.dam.armoniaskills.R.string.categoria1), context.getString(R.string.categoria2), context.getString(R.string.categoria3), context.getString(R.string.categoria4)
                , context.getString(R.string.categoria5), context.getString(R.string.categoria6), context.getString(R.string.categoria7), context.getString(R.string.categoria8),
